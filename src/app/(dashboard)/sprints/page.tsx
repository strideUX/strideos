                ...
                <TableBody>
                  {filteredSprints.map((sprint) => (
                    <TableRow key={sprint._id}>
                      ...
                      <TableCell>
                        <div className="text-sm">
                          <div>{sprint.committed || 0} / {sprint.capacity || 0} points</div>
                          <div className="text-muted-foreground">
                            {sprint.capacity ? Math.round((sprint.committed || 0) / sprint.capacity * 100) : 0}% utilized
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="text-sm">
                          <div>{sprint.completed || 0} / {sprint.committed || 0} completed</div>
                          <div className="text-muted-foreground">
                            {sprint.committed ? Math.round((sprint.completed || 0) / sprint.committed * 100) : 0}% done
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
