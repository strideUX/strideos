...
const CollaborativeEditor = dynamic(() => import('./components/collaborative-editor').then(m => m.CollaborativeEditor), { ssr: false });
...
export default function YSweetTestPage() {
  ...
  // Ensure consistent user object for provider
